...
export function PythonListComprehension() {
    return (
        <p>I've been brushing up on my python after not using it for a couple of years. Through doing a Codewars Kata with a Junior Dev friend, I learnt a nice bit of new knowledge about List Comprehenstion from him. <br /><br />
        ...
        <br />Then I defined a function which reversed the words with a length of 5 or more. I reversed the word by creating a new string and concatenating a letter at a time by iterating through a range. The range starts at the last index and increments -1 until it reaches the first index.
